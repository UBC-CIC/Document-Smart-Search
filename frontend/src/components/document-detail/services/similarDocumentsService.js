 ...
 */
export async function fetchSimilarDocuments(
  documentId,
  ...
  if (USE_MOCK_DATA) {
    ...
    try {
      ...
      let allDocuments =
        mockSimilarDocuments[documentId] || defaultSimilarDocuments;
  ...
  try {
    ...
    const response = await fetch(
      `${process.env.NEXT_PUBLIC_API_ENDPOINT}user/similarity-search`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
