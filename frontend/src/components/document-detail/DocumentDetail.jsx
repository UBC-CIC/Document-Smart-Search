...
import { PrimaryTopicsList, SecondaryTopicsList } from "./components/TopicsList"
...
export default function DocumentDetail({ documentId }) {
  ...
  const validRelatedDocuments = relatedDocuments.filter(doc => 
    doc.id !== "unknown" && 
      ...
      <main className="max-w-6xl mx-auto px-4 py-4">
        ...
        {loading ? (
          ...
          <div className="text-center p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md">
            <h3 className="text-xl font-bold text-red-600 dark:text-red-400 mb-4">Error Loading Document</h3>
            ...
            <div className="flex-1">
              <div className="bg-white dark:bg-gray-800 border dark:border-gray-700 rounded-lg shadow-sm">
                <div className="p-4 border-b dark:border-gray-700">
                  <h2 className="text-lg font-medium dark:text-white">{document.title}</h2>
                  <div className="flex justify-between mt-2 text-xs">
                    <div className="text-gray-600 dark:text-gray-400">Last Updated: {document.lastUpdated}</div>
          ...
          <div className="text-center p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md">
            <h3 className="text-xl font-bold text-red-600 dark:text-red-400 mb-4">Document Not Found</h3>
            <p className="text-gray-700 dark:text-gray-300 mb-6">The requested document could not be found.</p>
          </div>
        )}
      </main>
