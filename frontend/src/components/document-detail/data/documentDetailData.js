export const mockDocumentDetails = {
  6472: {
    ...
    year: "2021",
    subject:
      "Annual monitoring of Atlantic salmon populations on the east coast of Canada",
    csasEvent:
      "Framework for Assessing the Ecological Flow Requirements of Canada's East Coast Salmon",
    csasYear: "2021",
    documentUrl:
      "https://publications.gc.ca/site/archivee-archived.html?url=https://publications.gc.ca/collections/collection_2023/mpo-dfo/fs70-7/Fs70-7-2023-036-eng.pdf",
    ...
    relatedMandates: [
      {
        ...
        explanation:
          "This census directly supports the sustainability goals by providing population data needed for quota decisions",
        semanticScore: 0.92,
        llmScore: 0.88,
      },
      {
        ...
        explanation:
          "Salmon population monitoring is essential for determining if species are at risk and require protection",
        semanticScore: 0.85,
        llmScore: 0.91,
      },
      {
        ...
        explanation:
          "The data provides insights into overall ecosystem health and interactions between species",
        semanticScore: 0.79,
        llmScore: 0.82,
      },
      {
        ...
        explanation:
          "Population data informs consultations with Indigenous communities regarding traditional fishing rights",
        semanticScore: 0.76,
        llmScore: 0.74,
      },
    ],
    primaryTopics: [
      {
        ...
        explanation:
          "Detailed methodology for counting and assessing salmon populations across multiple rivers",
        semanticScore: 0.95,
        llmScore: 0.93,
      },
      {
        ...
        explanation:
          "Analysis of how salmon populations serve as indicators for broader ecosystem health",
        semanticScore: 0.87,
        llmScore: 0.89,
      },
    ],
    ...
    relatedDocuments: [
      {
        ...
        csasYear: "2021",
        documentUrl:
          "https://publications.gc.ca/site/eng/9.850192/publication.html",
      },
    ],
  },
  6273: {
    ...
    relatedMandates: [
      {
        name: "Sustainable Fisheries Framework",
        explanation:
          "This report directly addresses sustainable practices in aquaculture production",
        semanticScore: 0.94,
        llmScore: 0.96,
      },
      {
        name: "Aquatic Ecosystem Management",
        explanation:
          "The research evaluates impacts of aquaculture on surrounding ecosystems",
        semanticScore: 0.91,
        llmScore: 0.89,
      },
    ],
    primaryTopics: [
      {
        ...
        explanation:
          "Analysis of current management practices and recommendations for improvement",
        semanticScore: 0.98,
        llmScore: 0.97,
      },
    ],
