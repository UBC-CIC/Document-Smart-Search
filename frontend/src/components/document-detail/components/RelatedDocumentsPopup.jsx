...
export default function RelatedDocumentsPopup({
  ...
  const derivedTopicExplanation =
    "The semantic similarity of this document to the topic.";
  const mandateExplanation =
    "Relevance of this document to the mandate as rated by a LLM.";
  const dfoTopicExplanation =
        ...
        <div className="p-4 flex-1 overflow-y-auto">
          <div className="flex justify-between items-center mb-4">
            <div className="text-sm text-gray-600 dark:text-gray-400">
              <strong className="font-medium">{formatCount(totalCount)}</strong>{" "}
              documents related to this{" "}
              {topicType === "mandate" ? "mandate" : "topic"}
            </div>
