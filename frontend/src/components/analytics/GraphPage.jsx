...
import Filters from "../document-search/components/Filters";
import { SlidersHorizontal } from "lucide-react";
import { useDocumentSearch } from "../document-search/hooks/useDocumentSearch";

cytoscape.use(coseBilkent);

// Mock data with document URLs
const mandates = [
